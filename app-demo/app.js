...
// SỬA LỖI CONSTRUCTOR: Lấy module trước rồi mới lấy class
const OTelWinstonModule = require('@opentelemetry/winston-transport');
const WinstonTransport = OTelWinstonModule.WinstonTransport || OTelWinstonModule;

const express = require('express');
const winston = require('winston');

// 1. Cấu hình OTLP Log Exporter
